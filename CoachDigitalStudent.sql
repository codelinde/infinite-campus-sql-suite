...
SELECT DISTINCT
    ...
    LOWER(LEFT(vahs.firstName, 1)) + LOWER(vahs.lastName) + vahs.studentNumber AS 'Username (R)',
    ...
    LOWER(LEFT(vahs.firstName, 1) + vahs.lastName + vahs.studentNumber + '@mydomain.org') AS 'email address',
